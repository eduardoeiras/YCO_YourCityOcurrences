...
interface EndPoints {
    ...
    //Endponint de obtenção das ocorrências pelo título
    @GET("ocorrencias/getOcorrenciasTitulo/{titulo}")
    fun getAllOcorrenciasTitulo(@Path("titulo") titulo: String) : Call<RespostaOcorrencias>
